...
txn = read.transactions(file="~/Downloads/Data2.csv", rm.duplicates= TRUE, format="basket",sep=",",cols=1)
...
basket_rules<- apriori(txn,parameter = list(minlen=2,sup = 0.005, conf = 0.1,target="rules"))
...
print("Top 5 Hard subjects are")
print(subjectsfailing[1:5,1:2])
